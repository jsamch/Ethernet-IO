...
// start address and numbers for two sectors used for storing
// non-volatile variables
#define SECTOR1_STARTADDR 0x000E000
#define SECTOR1_SECTION   ".nvol1"
#define SECTOR1_NUM       6
#define SECTOR2_STARTADDR 0x000F000
#define SECTOR2_SECTION   ".nvol2"
#define SECTOR2_NUM       7
// size of sectors - they must be the same size
#define SECTOR_SIZE 0x1000
// CPU clock in kHz
#define CPU_CLK 120000
#define DISABLEIRQ __disable_irq();
#define ENABLEIRQ  __enable_irq();
#define IAP_LOCATION 0x1FFF1FF1
#endif // LPC17XX
...
typedef PRE_PACK struct _Sector_Record
{
...
} SECTOR_RECORD POST_PACK;

// defines a variable record
// members must be byte aligned
typedef PRE_PACK struct _Variable_Record
{
...
// for something else
static UNSIGNED8 mSectorMemory1[SECTOR_SIZE] __attribute__((section(SECTOR1_SECTION)));
static UNSIGNED8 mSectorMemory2[SECTOR_SIZE] __attribute__((section(SECTOR2_SECTION)));
